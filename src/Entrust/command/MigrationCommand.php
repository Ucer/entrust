<?php
namespace Ucer\Entrust\command;
...
class MigrationCommand extends Command
{
    ...
    {
        $this->laravel->view->addNamespace('entrust', substr(__DIR__, 0, -15).'views');
        ...
        $this->line(''); // 空行输出
        $this->info( "Tables: $rolesTable, $roleUserTable, $permissionsTable, $permissionRoleTable" );//绿色

        $message = "A migration that creates '$rolesTable', '$roleUserTable', '$permissionsTable', '$permissionRoleTable'".
            " tables will be created in database/migrations directory"; //黄色
